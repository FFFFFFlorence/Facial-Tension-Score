...
**1. Download all dependencies** 
   - Go to [Deployment for testing](</Deployment for testing>) folder, then download the [prototype_OpenFace_v2.3.zip](</Deployment for testing/prototype_OpenFace_v2.3.zip>) file. Extract the **.zip** file into the local directory. 
