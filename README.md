...
**1. Download all dependencies** 
   - Go to `Deployment for testing` folder, then download the `prototype_OpenFace_v2.3.zip` file.   
   ...
   - Download **OpenFace** model files. From the extracted **OpenFace** folder, there's a `download_models.ps1` script, right-click it and choose **"Run with PowerShell"**.  
     If windows blocks it, right-click the folder then choose **Open in Terminal**, then run:
      ```powershell
